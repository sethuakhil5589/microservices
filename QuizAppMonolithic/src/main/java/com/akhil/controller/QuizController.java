...
public class QuizController {
	...
	public ResponseEntity<String> submittingTest(@RequestBody List<String> answers, @PathVariable Integer id){
		
		return new ResponseEntity<>(service.submittingTest(answers, id),HttpStatus.OK);
	}
}
